      ...
      <header className="topbar">
        ...
        <div className="brand">
          ...
          <div>
            ...
            <p>
              Track your stock entries and exits
            </p>
          </div>
      ...
      <main className="main-content">
        ...
        <section className="summary-grid">
          ...
          <div className="summary-card">
            ...
            <div className="summary-icon sold-icon">
              ✓
            </div>
          ...
          {activeTab === "sold" && (
            ...
            soldEntries.length === 0 ? (
              ...
              <div className="empty-state">
                ...
                <p>
                  Sold positions will appear here
                  after you close an active entry.
                </p>
          ...
          >
            ...
            <div className="modal-header">
              ...
              <div>
                ...
                <p>
                  Enter your stock position details
                </p>
          ...
          >
            ...
            <div className="sell-warning">
              ...
              <p>
                ...
                Active Entries and moved to Sold
                Entries.
              </p>
